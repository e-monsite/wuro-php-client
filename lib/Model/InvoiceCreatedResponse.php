...
/**
 * InvoiceCreatedResponse Class Doc Comment
 *
 * @category Class
 * @package  Wuro\Api
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InvoiceCreatedResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InvoiceCreatedResponse';
...
'success' => 'getSuccess'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['new_invoice'] === null) {
            $invalidProperties[] = "'new_invoice' can't be null";
        }
